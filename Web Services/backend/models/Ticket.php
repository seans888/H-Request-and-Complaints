...
class Ticket extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['status', 'time_start', 'escalation_level', 'desc', 'check_in_id', 'emp_repond_id', 'category_id', 'emp_create_id'], 'required'],
            ...
            [['emp_repond_id'], 'exist', 'skipOnError' => true, 'targetClass' => Employee::className(), 'targetAttribute' => ['emp_repond_id' => 'id']],
            [['emp_create_id'], 'exist', 'skipOnError' => true, 'targetClass' => Employee::className(), 'targetAttribute' => ['emp_create_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(Employee::className(), ['id' => 'emp_repond_id']);
    }
    ...
    {
        return $this->hasOne(Employee::className(), ['id' => 'emp_create_id']);
    }
